# R03 Product Scope Contract

stage_id: R03
purpose: Execute and verify the Product Scope stage without skipping Harness order.
artifact_path: .harness/current/planning/PRODUCT_SCOPE.md

section_id: purpose
section_id: included_scope
section_id: excluded_scope
...
required_artifacts:
- .harness/current/planning/PRODUCT_SCOPE.md
