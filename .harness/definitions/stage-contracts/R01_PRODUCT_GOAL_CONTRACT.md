# R01 Product Goal Contract

stage_id: R01
purpose: Execute and verify the Product Goal stage without skipping Harness order.
artifact_path: .harness/current/planning/PRODUCT_GOAL_INTAKE.md

section_id: purpose
section_id: user_goal
section_id: success_criteria
section_id: clarifying_questions
section_id: decisions
section_id: open_items
section_id: next_stage_readiness
...
required_artifacts:
- .harness/current/planning/PRODUCT_GOAL_INTAKE.md
