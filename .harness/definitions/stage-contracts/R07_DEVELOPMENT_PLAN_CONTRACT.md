# R07 Development Plan Contract

stage_id: R07
purpose: Execute and verify the Development Plan stage without skipping Harness order.
artifact_path: .harness/current/planning/DEVELOPMENT_PLAN.md

section_id: purpose
section_id: phases
section_id: dependency_matrix
section_id: allocation_registry
section_id: test_targets
section_id: handoff_rules
...
required_artifacts:
- .harness/current/planning/DEVELOPMENT_PLAN.md
