# R08 Work Units Contract

stage_id: R08
purpose: Execute and verify the Work Units stage without skipping Harness order.
artifact_path: .harness/current/planning/WORK_UNITS.md

section_id: purpose
section_id: work_streams
section_id: work_units
section_id: dependency_edges
section_id: approval_targets
section_id: test_targets
section_id: ready_rules
...
required_artifacts:
- .harness/current/planning/WORK_UNITS.md
