# R04 User Experience Contract

stage_id: R04
purpose: Execute and verify the User Experience stage without skipping Harness order.
artifact_path: .harness/current/planning/USER_EXPERIENCE.md

section_id: purpose
section_id: users
section_id: workflows
section_id: screens_or_views
section_id: state_visibility
section_id: error_empty_loading_states
...
required_artifacts:
- .harness/current/planning/USER_EXPERIENCE.md
