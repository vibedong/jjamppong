# R06 Technical Architecture Contract

stage_id: R06
purpose: Execute and verify the Technical Architecture stage without skipping Harness order.
artifact_path: .harness/current/planning/TECHNICAL_ARCHITECTURE.md

section_id: purpose
section_id: runtime_structure
section_id: state_model
section_id: validation_model
section_id: security_boundaries
section_id: migration_policy
...
required_artifacts:
- .harness/current/planning/TECHNICAL_ARCHITECTURE.md
